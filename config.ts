...
const config = {
    ...
    botOwner:    process.env.BOT_OWNER     || 'Milton',
    ownerNumber: process.env.OWNER_NUMBER  || '263715907468',
    ...
    // Session
    sessionId:     process.env.SESSION_ID      || 'GlobalTechInfo/MEGA-MD_bdf6ffa1f1f8723ecee66257c40d7735',
